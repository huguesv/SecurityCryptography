...
/// </summary>
public class HashCalculatorProgress
{
    /// <summary>
    /// Initializes a new instance of the <see cref="HashCalculatorProgress"/> class.
    /// </summary>
    ...
    public HashCalculatorProgress(string filePath, int progressPercent, long progressBytes, long length)
    {
